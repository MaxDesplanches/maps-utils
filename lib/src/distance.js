...
function distanceInKmBetweenEarthCoordinates({ latitude1, longitude1, latitude2, longitude2, }) {
    latitude1 = (0, utils_1.degreesToRadians)(latitude1);
    longitude1 = (0, utils_1.degreesToRadians)(longitude1);
    latitude2 = (0, utils_1.degreesToRadians)(latitude2);
    longitude2 = (0, utils_1.degreesToRadians)(longitude2);
